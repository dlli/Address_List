...
<body>
	...
	<div class="container">
		<form action="<%=basePath%>contact/Add"  method="post">
			...
			<div class="form-group">
				...
				<input class="input-text"  name="item_alias" ></input>
			</div>
			<div class="form-group">
				<label class="label-text">联系电话</label>
				<input class="input-text"  name="item_tel" ></input>
			</div>
			<div class="form-group">
				<label class="label-text">住址</label>
				<input class="input-text"  name="item_addr" ></input>
			</div>
			<div class="form-group">
				<label class="label-text">生日</label>
				<input class="input-text"  name="item_birthday" onClick="WdatePicker()"></input>
			</div>
			<div class="form-group">
